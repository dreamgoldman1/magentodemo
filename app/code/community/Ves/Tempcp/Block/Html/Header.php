        ...
        if(!$this->isVenusTheme()) {
            ...
            if($header_layout) {
                if($header_file_path = Mage::helper("ves_tempcp/framework")->getLayoutPath("header/".$header_layout.".phtml","header/default.phtml")) {
                    ...
                    $current_catalog_product_path .= DS."common".DS."header".DS;
                    $header_layout = str_replace($current_catalog_product_path, "", $header_file_path);
                    $header_layout = str_replace(array(DS,".phtml"),array("/",""),$header_layout);
                    $header_layout = trim($header_layout);
