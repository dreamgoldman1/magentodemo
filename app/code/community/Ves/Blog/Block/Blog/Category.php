...
class Ves_Blog_Block_Blog_Category extends Ves_Blog_Block_Blog_Template
{
	...
	protected function _prepareLayout() {
		...
		$meta_description =  $this->category->getMetaDescription();
		$meta_description = $meta_description?$meta_description: $this->category->getTitle();
		...
		->setPageTitle( $meta_title_prefix. $this->category->getTitle() )
		->setHeadInfo( $this->category->getMetaKeyword(), $meta_description );
