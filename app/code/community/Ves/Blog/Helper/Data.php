     ...
     */
	 public function recursiveReplace($search, $replace, $subject)
	 {
	 	...
	 	public function getTagUrl($tag){
	 		$suffix_extension = Mage::getStoreConfig('ves_blog/general_setting/extension');
	 		$suffix_extension = $suffix_extension?".".$suffix_extension:"";
	 		return Mage::getBaseUrl().Mage::getStoreConfig('ves_blog/general_setting/route')."/tag/".$tag.$suffix_extension;
	 	}

	 	public function getAuthorUrl($author) {
	 		$suffix_extension = Mage::getStoreConfig('ves_blog/general_setting/extension');
	 		$suffix_extension = $suffix_extension?".".$suffix_extension:"";
	 		return Mage::getBaseUrl().Mage::getStoreConfig('ves_blog/general_setting/route')."/author/".$author.$suffix_extension;
	 	}
	 	public function getArchiveUrl($year){
	 		$suffix_extension = Mage::getStoreConfig('ves_blog/general_setting/extension');
	 		$suffix_extension = $suffix_extension?".".$suffix_extension:"";
	 		return Mage::getBaseUrl().Mage::getStoreConfig('ves_blog/general_setting/route')."/archive/".$year.$suffix_extension;
	 	}
