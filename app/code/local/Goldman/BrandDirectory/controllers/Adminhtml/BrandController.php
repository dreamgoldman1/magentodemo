...
class Goldman_BrandDirectory_Adminhtml_BrandController extends Mage_Adminhtml_Controller_Action {
    ...
    public function indexAction() {
        ...
        $brandBlock = $this->getLayout()
                ->createBlock('goldman_branddirectory_adminhtml/brand');
    ...
    public function editAction() {
        ...
        if ($brandId = $this->getRequest()->getParam('id', false)) {
            ...
            if ($brand->getId()) {
                ...
                return $this->_redirect(
                                'goldman_branddirectory_admin/brand/index'
                );
            }
        }
        ...
        if ($postData = $this->getRequest()->getPost('brandData')) {
            try {
                ...
                return $this->_redirect(
                                'goldman_branddirectory_admin/brand/edit', array('id' => $brand->getId())
                );
            } catch (Exception $e) {
                Mage::logException($e);
        ...
        $brandEditBlock = $this->getLayout()->createBlock(
                'goldman_branddirectory_adminhtml/brand_edit'
        );
        ...
        switch ($actionName) {
            ...
            default:
                ...
                $isAllowed = $adminSession
                        ->isAllowed('goldman_branddirectory/brand');
                break;
        }
