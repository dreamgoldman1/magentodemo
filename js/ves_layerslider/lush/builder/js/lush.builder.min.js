...
jQuery(function ($) {
    ...
    function ajaxUploadImage(image_name, image_source_data) {
        ...
        /** Remove the ajax upload base 64 images
        $("#ajax_loading").show();
        $.ajax({
            url: ajaxUploadImageUrl,
            dataType: 'json',
            async: false,
            timeout: 10000,
            type: 'post',
            data: {"form_key": form_key,"image_name" : image_name, "source" : image_source_data},
            success: function(data) {
                if (data.status == "SUCCESS") {
                    status_uploaded.status = true;
                    status_uploaded.imageSrc = data.imageSrc;
                }
            }
        });*/
    ...
    $(document).ready(function () {
        ...
        text: function (e) {
            ...
            return e.src = e.src64 = "", t = $("<div/>", {
                ...
                "data-id": "#pover-text",
                "data-customclase": e.customclase,
